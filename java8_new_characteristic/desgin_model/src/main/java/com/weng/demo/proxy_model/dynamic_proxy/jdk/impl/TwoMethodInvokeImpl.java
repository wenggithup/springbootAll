 ...
 * @Description:
 */
public class TwoMethodInvokeImpl implements DemoServerMethodInvoke {
    @Override
    public int getOrder() {
        return 1245;
    }
    ...
    public Object intercept(Object proxy, Method method, Object[] args, DemoProxyHandleInvoke proxyHandleInvoke) throws InvocationTargetException, IllegalAccessException {
        System.out.println("这是 TwoMethodInvokeImpl.... ");
        // 方法名
        ...
        System.out.println("TwoMethodInvokeImpl 执行代理方法之前。。。。。");
        //执行代理方法
        Object result = proxyHandleInvoke.invoke(proxy,args);
//        System.out.println(result.toString());
        System.out.println("TwoMethodInvokeImpl 执行代理方法结束。。。。。");
        return result;
    }
}
